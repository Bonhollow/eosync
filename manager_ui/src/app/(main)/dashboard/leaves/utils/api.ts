...
import { Leave, LeaveCreate, LeaveUpdate, Employee } from "../_components/schema";
...
export const updateLeave = async (id: number, leaveData: Partial<LeaveUpdate>): Promise<Leave> => {
