...
export function TableCards() {
  ...
  const [newProject, setNewProject] =
    useState<NewProjectPayload>(initialProjectState);
  ...
  const handleSaveProjectAndTasks = async () => {
    ...
    try {
      ...
      alert(
        "Failed to save the project. Please check the console for details.",
      );
    }
  };
  ...
  const handleAiAssist = async () => {
    ...
    try {
      ...
      if (!aiProject) {
        alert(
          "The AI could not generate project details from your description. Please try again.",
        );
        return;
      }
  ...
  const renderTasksStep = () => (
    <div className="py-4 max-h-[70vh] overflow-y-auto pr-4">
      <div className="flex justify-between items-center mb-4">
        <div>
          ...
          <p className="text-sm text-muted-foreground">
            Add or manage tasks for this project.
          </p>
        </div>
      ...
      <Button variant="link" onClick={() => setStep(1)} className="px-0 mt-4">
      ...
      <Card className="shadow-xs">
        <CardHeader className="flex-row items-start justify-between">
          <div>
            ...
            <CardDescription>
              Track and manage your company's projects
            </CardDescription>
          </div>
          <CardAction>
      ...
      <Dialog open={openModal} onOpenChange={handleModalOpenChange}>
        <DialogContent className="sm:max-w-2xl">
          <DialogHeader>
            <DialogTitle>
              {manualMode
                ? `Add New Project - Step ${step} of 2`
                : "Add New Project"}
            </DialogTitle>
            <DialogDescription>
              {!modeSelected
                ...
                : manualMode
                  ? step === 1
                    ? "Fill in the core details for your new project."
                    : "Add and manage the project's tasks."
          ...
          <DialogFooter className="pt-4">
            ...
            {modeSelected && manualMode && (
              <>
                ...
                {step === 2 && (
                  <Button onClick={handleSaveProjectAndTasks}>
                    Save Project
                  </Button>
                )}
              </>
